...
function startpmt2() {
    ...
    diva3.className = "input-field with-iconn margin-bottom";
    ...
    diva5.className = "input-field with-icon margin-bottomm";
    ...
    diva6.className = "input-fieldd with-icon margin-bottom";
    ...
    labela11.innerHTML = '2 - First Name?';
    // diva3.appendChild(spana3);
...
function finishpmt2() {
    ...
    if (headcount != parseInt(iii)) {
        ...
        var rew = document.getElementById("review");
    ...
    for (var i = 0; i <= forms; i++) {
        if (i == 0) {
            ...
            if ($.trim(age) == '') {
                ...
                alert('Question on gender has not been answered for principal');
                return false;
            } else if ($.trim(school) == '') {
                alert('Question on school has not been answered for principal');
                return false;
            } else if ($.trim(height) == '') {
                alert('Question on height has not been answered for principal');
                return false;
            } else if ($.trim(weight) == '') {
                alert('Question on weight has not been answered for principal');
                return false;
            } else if ($.trim(bmi) == '') {
                alert('Question on bmi has not been answered for principal');
                return false;
            } else if ($.trim(mal) == '') {
                alert('Question on malnutrition  has not been answered for principal');
                return false;
            } else if ($.trim(work) == '') {
                alert('Question on work has not been answered for principal');
                return false;
            }
            //localStorage.question2 = "age=" + age + "&gender=" + gender + "&school=" + school + "&height=" + height + "&weight=" + weight + "&bmi=" + bmi + "&mal=" + mal + "&work=" + work + "|";// + "&headcount=" + headcount2 + "&state=" + state + "&lga=" + lga + "&ward=" + ward + "&scoredata=" + scoredata + "&agent=" + agent + "&pushscreenpmt=";
            localStorage.question2 = '"age":"' + age + '","gender":"' + gender + '","school":"' + school + '","height":"' + height + '","weight":"' + weight + '","bmi":"' + bmi + '","mal":"' + mal + '","work":"' + work + "|";// '","sevenone":"' + sevenone + '","seventwo":"' + seventwo + '","seventhree":"' + seventhree + '","sevenfour":"' + sevenfour + '","sevenfive":"' + sevenfive + '","sevensix":"' + sevensix + '","eight":"' + eight + '","nine":"' + nine + '","ten":"' + ten + '","eleven":"' + eleven + '","headcount":"' + headcount + '"';
            ...
            if ($.trim(age) == '') {
                alert('Question on year of birth has not been answered for individual ' + i);
                return false;
            } else if ($.trim(gender) == '') {
                alert('Question on gender has not been answered for  individual ' + i);
                return false;
            }
            ...
            if (document.getElementById("schteen" + i)) {
                ...
                if ($.trim(age) == '') {
                    ...
                    alert('Question on school has not been answered for  individual ' + i);
                    return false;
                }
                eduteen[i] = (school == "Yes") ? 0 : 1;
                localStorage.question2 = localStorage.question2.concat('"age' + i + '":"' + age + '","gender' + i + '":"' + gender + '","schteen' + i + '":"' + school + "|");
                ...
                if ($.trim(age) == '') {
                    ...
                    alert('Question on height has not been answered for individual ' + i);
                    return false;
                } else if ($.trim(weight) == '') {
                    alert('Question on weight has not been answered individual ' + i);
                    return false;
                } else if ($.trim(bmi) == '') {
                    alert('Question on bmi has not been answered for individual ' + i);
                    return false;
                } else if ($.trim(mal) == '') {
                    alert('Question on malnutrition  has not been answered for individual ' + i);
                    return false;
                } else if ($.trim(work) == '') {
                    alert('Question on work has not been answered for individual ' + i);
                    return false;
                }
                localStorage.question2 = localStorage.question2.concat('"age' + i + '":"' + age + '","gender' + i + '":"' + gender + '","school' + i + '":"' + school + '","height' + i + '":"' + height + '","weight' + i + '":"' + weight + '","bmi' + i + '":"' + bmi + '","mal' + i + '":"' + mal + '","work' + i + '":"' + work + "|");// + "&headcount=" + headcount2 + "&state=" + state + "&lga=" + lga + "&ward=" + ward + "&scoredata=" + scoredata + "&agent=" + agent + "&pushscreenpmt=";
            } else {
                var gender = document.getElementById("gender" + i).value;
                localStorage.question2 = localStorage.question2.concat('"age' + i + '":"' + age + '","gender' + i + '":"' + gender + "|");// + "&headcount=" + headcount2 + "&state=" + state + "&lga=" + lga + "&ward=" + ward + "&scoredata=" + scoredata + "&agent=" + agent + "&pushscreenpmt=";
            }
        }
    }
...
function ret3b(v) {
    ...
    spanb3b.innerHTML = ('3 - Is this person attending school at this time?');
...
function ret8(v) {
    ...
    var spanb8 = document.createElement("span");
    spanb8.className = "span2";
    spanb8.innerHTML = ('8 - Is this person looking for work, but not working?');
    var divc8 = document.createElement("div");
    divc8.className = "col-sm-10";
    var inputa8 = document.createElement("select");
    inputa8.name = 'work' + v;
...
function ret7(v) {
    ...
    var spanb7 = document.createElement("span");
    spanb7.className = "span2";
    spanb7.innerHTML = ('7 - Is this person malnourished?');
    var divc7 = document.createElement("div");
    divc7.className = "col-sm-10";
    var inputa7 = document.createElement("select");
    inputa7.name = 'mal' + v;
...
function ret6(v) {
    ...
    labela6.innerHTML = '6 - What is this person\'s Body Mass Index?'
...
function ret5(v) {
    ...
    labela5.className = 'firecolor';
    labela5.innerHTML = '5 - What is this person\'s weight in kg';
...
function ret4(v) {
    ...
    labela4.className = 'firecolor';
    labela4.innerHTML = '4 - What is this person\'s height in meters';
...
function ret3(v) {
    ...
    labela3.className = 'firecolor';
    labela3.innerHTML = '3 - How many years of schooling has this person had?';
    // diva3.appendChild(spana3);
    diva3.appendChild(inputa3);
    diva3.appendChild(labela3);
    return diva3;
...
function finishpmt22() {
    ...
    for (var i = 0; i <= headcount; i++) {
        if (i == 0) {
            ...
            var age = document.getElementById("age").value;
            if ($.trim(name) == '') {
                alert('Question Name has not been answered for Individual 1');
                return false;
            } else if ($.trim(gender) == '') {
                alert('Question Gender has not been answered for Individual 1');
                return false;
            } else if ($.trim(age) == '') {
                alert('Question Age has not been answered for Individual 1');
                return false;
            }
            ...
            var x = i + 1;
            if ($.trim(namey) == '') {
                alert('Question Name has not been answered for Individual ' + x);
                return false;
            } else if ($.trim(gendery) == '') {
                alert('Question Gender has not been answered for Individual ' + x);
                return false;
            } else if ($.trim(agey) == '') {
                alert('Question Age has not been answered for Individual ' + x);
                return false;
            }
...
function clickme() {
    var resp = getAge(document.getElementById('age').value);
    if (resp == "3" || resp == "4") {
        document.getElementById('lantitb2').style.display = "table-row";
    } else {
        document.getElementById('lantitb').style.display = "table-row";
    }
...
function clickme2() {
    ...
    document.getElementById('lantitb2').style.display = "none";
...
function showDivResp(elem) {
    ...
    document.getElementById('hiv').selectedIndex = 0;
    document.getElementById('xray').selectedIndex = 0;
    document.getElementById('antitb').selectedIndex = 0;
    ...
    var resp = getAge(document.getElementById('age').value);
    if (resp == 4) {
        document.getElementById('lxray').style.display = "none";
    } else {
        document.getElementById('lxray').style.display = "table-row";
    }
}
...
function validatePrincipal() {
    ...
    if ($.trim(age) == '') {
        ...
        alert('Question on Last Name has not been answered for principal');
        document.getElementById('cough').selectedIndex = 0;
        document.getElementById('xray').selectedIndex = 0;
        return false;
    } else if ($.trim(oname) == '') {
        alert('Question on First Name has not been answered for principal');
        document.getElementById('cough').selectedIndex = 0;
        document.getElementById('xray').selectedIndex = 0;
        return false;
    }
    //localStorage.question2 = "age=" + age + "&gender=" + gender + "&school=" + school + "&height=" + height + "&weight=" + weight + "&bmi=" + bmi + "&mal=" + mal + "&work=" + work + "|";// + "&headcount=" + headcount2 + "&state=" + state + "&lga=" + lga + "&ward=" + ward + "&scoredata=" + scoredata + "&agent=" + agent + "&pushscreenpmt=";
    localStorage.question2 = '"age":"' + age + '","gender":"' + gender + '","school":"' + school + '","height":"' + height + '","weight":"' + weight + '","bmi":"' + bmi + '","mal":"' + mal + '","work":"' + work + '","fname":"' + fname + '","oname":"' + oname + '","|"';// '","sevenone":"' + sevenone + '","seventwo":"' + seventwo + '","seventhree":"' + seventhree + '","sevenfour":"' + sevenfour + '","sevenfive":"' + sevenfive + '","sevensix":"' + sevensix + '","eight":"' + eight + '","nine":"' + nine + '","ten":"' + ten + '","eleven":"' + eleven + '","headcount":"' + headcount + '"';
    //alert('all checked');
}
...
function showDivCough(elem) {
    ...
    document.getElementById('nofever').checked = false;
    document.getElementById('noweightloss').checked = false;
    document.getElementById('ldoc').style.display = "none";
    document.getElementById('lsupost').style.display = "none";
    document.getElementById('lantitb').style.display = "none"
    document.getElementById('lantitb2').style.display = "none";
    ...
    if (elem.value == 1) {// yes cough
        if (hiv == 1) {
            ...
            document.getElementById('lweight').style.display = "none"
            document.getElementById('lmore').style.display = "table-row";
            document.getElementById('lgrowth').style.display = "none";
        }
    } else if (elem.value == 2) { // no cough
        document.getElementById('lmore').style.display = "none";
        if (resp == 4) {
            document.getElementById('lgrowth').style.display = "table-row";
            document.getElementById('lweight').style.display = "none";
            document.getElementById('lmore').style.display = "none";
        } else {
            document.getElementById('lweight').style.display = "table-row";
            document.getElementById('lfever').style.display = "table-row";
            document.getElementById('lgrowth').style.display = "none";
            document.getElementById('lmore').style.display = "none";
        }
    }
    ...
    if (resp == 4) {
        if (cough == 1) { //yes cough
            if (elem.value == 1) {//yes grow
                ...
                document.getElementById('lfever').style.display = "none";
                document.getElementById('yeas3').click(); // yes tb flag by cough and >2 weeks
                document.getElementById('ldoc').style.display = "table-row";
                // document.getElementById('lsupost').style.display = "block";
            }
...
function showDivFever(elem) {
    var resp = getAge(document.getElementById('age').value);
    var weight = document.getElementById('weightloss').checked;
    var noweight = document.getElementById('noweightloss').checked;
    document.getElementById('antitb').selectedIndex = 0;
    document.getElementById('lsweat').style.display = "none";
    document.getElementById('nosweat').checked = false;
    document.getElementById('sweat').checked = false;
    document.getElementById('lsupost').style.display = "none";
    document.getElementById('lantitb').style.display = "none"
    document.getElementById('lantitb2').style.display = "none";
    //document.getElementById('contact').style.display = "none";
    ...
    if (resp == 4) {
        if (elem.value == "nofever") {
            ...
            document.getElementById('lsweat').style.display = "table-row";
        }
    }
    else if (resp != 4) {
        if (weight == true) {
...
function showDivSweat(elem) {
    ...
    if (document.getElementById('weightloss').checked) {
        weightloss = true;
    } else if (document.getElementById('noweightloss').checked) {
        weightloss = false;
    }
    if (document.getElementById('fever').checked) {
        fever = true;
    } else if (document.getElementById('nofever').checked) {
        fever = false;
    }
    ...
    if (elem.value == 'sweat') {
        ...
        if (weightloss == false && fever == false) {
            document.getElementById('ltb').style.display = "table-row";
...
function showDivTB(elem) {
    ...
    if (document.getElementById('sweat').checked) {
        sweat = true;
    } else if (document.getElementById('nosweat').checked) {
        sweat = false;
    }
